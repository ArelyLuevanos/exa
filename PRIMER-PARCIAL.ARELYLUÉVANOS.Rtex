...
summary.data.frame(panel[,c("luz" , "x0" , "x1" , "x2" , "x3" , "x4", "x5")])
...
#para cada estado; por otro lado la variable que más afecta a la variable dependiente es x1, probablemente
...
#Serï¿½a conveniente establecer una nueva regresiï¿½n donde se establezacan logaritmos en las variables
...
#para conocer a plenitu el comportamiento de esas variables.
